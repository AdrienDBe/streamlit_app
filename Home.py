...
with st.sidebar:
    ...
    st.markdown("<p style='text-align: center; font-size: 18px;'><u>Business application:</u></p>", unsafe_allow_html=True)
    ...
    st.markdown("<p style='text-align: center; font-size: 18px;'><u>API Explorers:</u></p>", unsafe_allow_html=True)
