...
st.markdown(
    "<h6>Use a sample dataset or import your own here: <a href='https://adrien.streamlit.app/Clustering_tool' target='_blank' style='font-size: 20x;'>https://adrien.streamlit.app/Clustering</a></h6>",
    unsafe_allow_html=True
)
